from PyQt5.QtWidgets import (
    ...
    QGraphicsOpacityEffect  # إضافة لتأثير الشفافية
)
...
class SplashScreen(QWidget):
    def __init__(self):
        ...
        self.timer_particles.start(100)  # تغيير إلى 100 مللي ثانية لتقليل عدد الجسيمات
...
class Particle(QLabel):
    def __init__(self, parent, position, size):
        ...
        # Fade animation باستخدام QGraphicsOpacityEffect
...
class QARKGui(QWidget):
    def __init__(self):
        ...
        gradient.setColorAt(0, QColor(0, 30, 60))  # درجة لون داكنة من الأعلى
        gradient.setColorAt(1, QColor(0, 180, 255))  # درجة لون أفتح في الأسفل
    ...
    def add_shadow_effect(self, widget):
        """إضافة تأثير الظل لعناصر واجهة المستخدم"""
